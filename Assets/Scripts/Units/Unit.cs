...
namespace TDS
{
    ...
    public class Unit : MonoBehaviour
    {
        ...
        [SerializeField]
        protected Weapon _weaponClass; // в последующем будет братьс€ из кода
        ...
        protected void ToShoot(Transform parent, Transform weapon)
        {
            ...
            {
                Debug.Log(" -------------- Ќет патронов дл€ стрельбы---------------");
            }
#endif
        }
        ...
        protected void Death()
        {
            ...
            if (TryGetComponent<NPC_Test>(out var r)) r.DestroyNPC(); // заменить NPC_Test на итоговое им€ класса
        }
