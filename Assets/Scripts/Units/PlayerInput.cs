...
namespace TDS
{
    ...
    public class PlayerInput : Unit
    {
        ...
        private void FixedUpdate()
        {
            ...
            //_moveDirection = new Vector3(_movement.x - norm.x, 0f, _movement.y - norm.z);// ÚÛÚ ËÒÔ‡‚ËÚ¸
        ...
        protected override void OnTriggerEnter(Collider other)
        {
            ...
            switch (_triggerType)
            {
                ...
                case TriggerType.AidKit:
                    ...
                    //if (_currentHealth > unitParams._maxHealth) _currentHealth = unitParams._maxHealth; Õ≈ «¿¡€“‹ ¬ Àﬁ◊»“‹ Œ¡–¿“ÕŒ œŒ—À≈ œ–Œ¬≈–Œ !
                    Destroy(other.gameObject);
                    break;
